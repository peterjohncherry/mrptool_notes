...
and tensor contraction library, and a task manager (make figure).\\
...
defined in Bagel. The tensor libraries make use of the SMITH::Tensor class defined in Bagel,
which in turn makes use of the TiledArray libraries for parallel storage of the data. 
The routines in the tensor arithmetic library are built using 
a combination of calls to LAPACK, and the tensor transposition routine defined in
btas\footnote{ To clarify, whilst btas has some tensor contraction routines, 
